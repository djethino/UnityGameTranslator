...
namespace UnityGameTranslator.Core.Checks
{
    ...
    /// 2. TestData/Shaping/*.txt — the ten classic Indic scripts, several hundred words, one
    ///    file per script, generated by tools/shaping-oracle/harfbuzz-expectations.py from
    ///    the fonts in TestData/Fonts. What they prove is agreement with the reference shaper
    ///    the fonts were built against, word by word, glyph by glyph, unit by unit.
    ///
    ...
    internal static class IndicShaperChecks
    {
        ...
        public static void Run(Action<bool, string, string> check)
        {
            ...
            // The ten scripts, from the oracle's files: one line per file in the report, every
            // word compared, the first disagreements named.
            ...
            foreach (string file in files)
            {
                ...
                check(failures.Count == 0, script + ": " + words + " words against HarfBuzz",
                    failures.Count == 0 ? "= HarfBuzz, every glyph and unit" : failures.Count + " differ — " + string.Join(" | ", failures.GetRange(0, Math.Min(3, failures.Count))));
            }
        }
