...
# The Noto family that carries a script: Sans, except where Noto ships the script as Serif only.
FONT_FILE = {"Tibetan": "NotoSerifTibetan.ttf"}


def font_for(script):
    return os.path.join(FONTS, FONT_FILE.get(script, f"NotoSans{script}.ttf"))
